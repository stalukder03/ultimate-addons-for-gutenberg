...
if ( $attr['showName'] ) {
	$selectors[' .uagb-tm__author-name'] = array(
...
if ( $attr['showCompany'] ) {
	$selectors[' .uagb-tm__company'] = array(
		'color' => $attr['companyColor'],
	);
}

if ( $attr['showContent'] ) {
	$selectors[' .uagb-tm__desc'] = array(
...
if ( $attr['showImg'] ) {
	$selectors[' .uagb-testimonial__wrap .uagb-tm__image-content']      = array(
	...
	$selectors[' .uagb-tm__image img']                                  = array(
	...
	$selectors[' .uagb-tm__image-position-top .uagb-tm__image-content'] = array(
		'justify-content' => $img_align,
	);
	$m_selectors['  .uagb-testimonial__wrap .uagb-tm__image-content']   = array(
	...
	$t_selectors[' .uagb-testimonial__wrap .uagb-tm__image-content']    = array(
