...
$selectors = array(
	...
	'.uagb-infobox__content-wrap .uagb-ifb-icon-wrap svg' => array(
		...
		'color'         => $attr['iconColor'],
		'fill'          => $attr['iconColor'],
		'margin-left'   => UAGB_Helper::get_css_value( $icon_margin_left, 'px' ),
		'margin-right'  => UAGB_Helper::get_css_value( $icon_margin_right, 'px' ),
		'margin-top'    => UAGB_Helper::get_css_value( $icon_margin_top, 'px' ),
		'margin-bottom' => UAGB_Helper::get_css_value( $icon_margin_bottom, 'px' ),
	),
