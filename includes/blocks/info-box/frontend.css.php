...
$icon_margin_top         = is_int( $attr['iconTopMargin'] ) ? $attr['iconTopMargin'] : 0;
$icon_margin_bottom      = is_int( $attr['iconBottomMargin'] ) ? $attr['iconBottomMargin'] : 0;
$icon_margin_left        = is_int( $attr['iconLeftMargin'] ) ? $attr['iconLeftMargin'] : 0;
$icon_margin_right       = is_int( $attr['iconRightMargin'] ) ? $attr['iconRightMargin'] : 0;
...
$selectors = array(
	...
	'.uagb-infobox__content-wrap .uagb-ifb-icon-wrap svg' => array(
		...
		'color'         => $attr['iconColor'],
		'fill'          => $attr['iconColor'],
		'margin-left'   => UAGB_Helper::get_css_value( $icon_margin_left, $attr['iconMarginUnit'] ),
		'margin-right'  => UAGB_Helper::get_css_value( $icon_margin_right, $attr['iconMarginUnit'] ),
		'margin-top'    => UAGB_Helper::get_css_value( $icon_margin_top, $attr['iconMarginUnit'] ),
		'margin-bottom' => UAGB_Helper::get_css_value( $icon_margin_bottom, $attr['iconMarginUnit'] ),
	),
