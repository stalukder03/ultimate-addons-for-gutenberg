		...
		public static function get_block_attributes() {
			...
			if ( null === self::$block_attributes ) {
				self::$block_attributes = array(
					...
					'uagb/fse-navigation'         => array(
						'slug'        => '',
						'title'       => __( 'Navigation', 'ultimate-addons-for-gutenberg' ),
						'description' => __( 'This block allows you to display Navigation Menu.', 'ultimate-addons-for-gutenberg' ),
						'default'     => true,
						'extension'   => false,
						'attributes'  => array(
							'menu_id'                    => '',
							...
							'leftPaddingMobile'          => '',
							'rightPaddingMobile'         => '',
							'navigationFontFamily'       => 'Default',
							'navigationFontWeight'       => '',
							'navigationFontSubset'       => '',
							'navigationFontSizeType'     => 'px',
							'navigationLineHeightType'   => 'em',
							'navigationFontSize'         => '',
					...
					'uagb/fse-page-list'          => array(
						'slug'        => '',
						'title'       => __( 'Page List', 'ultimate-addons-for-gutenberg' ),
						'description' => __( 'This block allows you to display Page List.', 'ultimate-addons-for-gutenberg' ),
						'default'     => true,
						'extension'   => false,
						'attributes'  => array(
							'align'                    => '',
							...
							'leftPaddingMobile'        => '',
							'rightPaddingMobile'       => '',
							'pageListFontFamily'       => 'Default',
							'pageListFontWeight'       => '',
							'pageListFontSubset'       => '',
							'pageListFontSizeType'     => 'px',
							'pageListLineHeightType'   => 'em',
							'pageListFontSize'         => '',
