...
if ( ! class_exists( 'UAGB_Block_JS' ) ) {
	...
	class UAGB_Block_JS {
		...
		public static function blocks_advanced_heading_gfont( $attr ) {
			...
			$subhead_font_variant     = isset( $attr['subHeadFontVariant'] ) ? $attr['subHeadFontVariant'] : '';

			UAGB_Helper::blocks_google_font( $head_load_google_font, $head_font_family, $head_font_weight, $head_font_variant );
			UAGB_Helper::blocks_google_font( $subhead_load_google_font, $subhead_font_family, $subhead_font_weight, $subhead_font_variant );
		}
