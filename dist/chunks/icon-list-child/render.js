...
const Render = props => {
  ...
  if (image_icon === 'icon') {
    if (icon || fromParentIcon) {
      imageIconHtml = icon ? Object(_Controls_renderIcon__WEBPACK_IMPORTED_MODULE_1__["default"])(icon) : Object(_Controls_renderIcon__WEBPACK_IMPORTED_MODULE_1__["default"])(fromParentIcon);
    }
