...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".uag-star-rating__wrapper .block-editor-rich-text__editable.uag-star-rating__title {\n  margin: 0;\n  margin-right: 10px; }\n", "",{"version":3,"sources":["webpack://./src/blocks/star-rating/editor.lazy.scss"],"names":[],"mappings":"AAAA;EACE,SAAS;EACT,kBAAkB,EAAE","sourcesContent":[".uag-star-rating__wrapper .block-editor-rich-text__editable.uag-star-rating__title {\n  margin: 0;\n  margin-right: 10px; }\n"],"sourceRoot":""}]);
// Exports
...
const Render = props => {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement("div", {
    className: classnames__WEBPACK_IMPORTED_MODULE_0___default()(className, `uagb-editor-preview-mode-${deviceType.toLowerCase()}`, `uag-star-rating__layout-${layout}`, 'uag-star-rating__wrapper', `uagb-block-${props.clientId.substr(0, 8)}`)
