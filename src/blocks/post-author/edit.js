...
class UAGBPostAuthorEdit extends Component {
    ...
    render() {
		...
		const author_data = (
			post_author.uagb_author_info && post_author.uagb_author_info.display_name && post_author.uagb_author_info.author_link ? (
			<div className={ `uagb-post-author__wrap uagb-block-${ this.props.clientId.substr( 0, 8 )}`}>
