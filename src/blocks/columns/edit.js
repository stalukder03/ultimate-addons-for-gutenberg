	...
	render() {
		...
		const bottomSettings = (
			<Fragment>
				...
				{ bottomType != "none" &&
					<Fragment>
						<p className="uagb-setting-label">{ __( "Color", "ultimate-addons-for-gutenberg" ) }<span className="components-base-control__label"><span className="component-color-indicator" style={ { bottomColor } } ></span></span></p>
						<ColorPalette
							value={ bottomColor }
		...
		const topSettings = (
			<Fragment>
				...
				{ topType != "none" &&
					<Fragment>
						<p className="uagb-setting-label">{ __( "Color", "ultimate-addons-for-gutenberg" ) }<span className="components-base-control__label"><span className="component-color-indicator" style={ { topColor } } ></span></span></p>
						<ColorPalette
							value={ topColor }
