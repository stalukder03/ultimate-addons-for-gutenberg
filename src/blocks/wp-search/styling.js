...
function styling( props ) {
	...
	const $hInputPaddingTablet = generateCSSUnit( hinputPaddingTablet, inputPaddingTypeDesktop );
	const $vInputPaddingMobile = generateCSSUnit( vinputPaddingMobile, inputPaddingTypeDesktop );
