...
class UAGBPostContentEdit extends Component {
        ...
        return (
                <Fragment>
					...
					<div className={ classnames(
						...
						"uagb-post-content__wrap",
						) } dangerouslySetInnerHTML={{ __html: post_content.content }}>
					</div>
            </Fragment>
        );
    }
...
export default UAGBPostContentEdit;