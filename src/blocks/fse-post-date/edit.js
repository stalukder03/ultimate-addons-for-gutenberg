                ...
                <Fragment>
                    ...
                    <InspectorControls>
						...
						<p className="uagb-setting-label">{ __( "Date"  , 'ultimate-addons-for-gutenberg') }</p>
							...
							/>
							<p className="uagb-setting-label">{ __( "Date Text Color" , 'ultimate-addons-for-gutenberg' ) }<span className="components-base-control__label"><span className="component-color-indicator" style={{ backgroundColor: dateColor }} ></span></span></p>
							<ColorPalette
								value={ dateColor }
