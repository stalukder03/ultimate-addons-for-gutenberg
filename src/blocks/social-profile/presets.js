...
import defaultChildAttributes from '../social-profile-child/attributes';
...
const presets = [
    ...
    },
	{
        ...
        icon: '<svg xmlns="http://www.w3.org/2000/svg" width="325" height="245" viewBox="0 0 325 245" fill="none"> <path d="M27 31.7987C27 29.1485 29.1527 27 31.8081 27H294.192C296.847 27 299 29.1485 299 31.7987V245H27V31.7987Z" fill="white"/> <ellipse cx="163.5" cy="136" rx="34.7621" ry="35" fill="#B6B6B6"/> <ellipse cx="163.389" cy="135.888" rx="9.23369" ry="9.29688" fill="#E6E7E9"/> </svg>',
    }

];

export default applyFilters(
    `uag_social_profile_presets`,
    presets
);
