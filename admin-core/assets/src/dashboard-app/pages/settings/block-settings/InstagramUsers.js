...
const InstagramUsers = () => {
	...
	const UAG_IG_TOKEN_GENERATOR = 'https://dev.ultimategutenberg.com/auth/instagram/';
	const UAG_IG_BASIC_APP_ID = 432767105395971;
	const UAG_IG_BASIC_REDIRECT = 'https://dev.ultimategutenberg.com/auth/instagram/basic/';
    
    window.addEventListener( 'message', ( event ) => {
		if ( ! event.origin.startsWith( 'https://dev.ultimategutenberg.com' ) ){
			return;
		}
